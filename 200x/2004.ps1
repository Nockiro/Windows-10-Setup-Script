...
# Включить новый стиль Пуска, если номер билда минимум 19041.423. Релиз назначен на выход Windows 10 20H2.
...
if ($RU)
{
	...
	$Message = "Хотите, чтобы Microsoft Defender ограничивал доступ к указанным вами папкам с конфиденциальной информацией?"
	$Options = "&Добавить", "&Пропустить"
}
else
{
	$Title = "Controlled folder access"
	$Message = "Would you like Microsoft Defender to restrict access to sensitive folders that you specify?"
	$Options = "&Add", "&Skip"
}
$DefaultChoice = 1
